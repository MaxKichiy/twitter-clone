...
export interface SetAddFormStateInterface{
...
export type TweetsActions = SetTweetsActionInterface | SetTweetsLoadingStateInterface | FetchTweetsActionInterface | FetchAddTweetActionInterface | AddTweetActionInterface | SetAddFormStateInterface;
